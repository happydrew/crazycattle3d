  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <header className="text-center mb-8">
        <h1 className="text-4xl font-bold text-gray-800">Crazy Flips 3D</h1>
        <p className="text-lg text-gray-600">Perform breathtaking flips and stunts in this thrilling acrobatic game.</p>
      </header>
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-semibold text-gray-800 mb-4">Gameplay Mechanics</h2>
        <p className="text-gray-700 mb-4">
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-semibold text-gray-800 mb-4">Strategy Tips</h2>
        <ul className="list-disc pl-5 text-gray-700">
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-semibold text-gray-800 mb-4">Visuals and Sound</h2>
        <p className="text-gray-700">
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-semibold text-gray-800 mb-4">Example Gameplay Video</h2>
      ...
      <footer className="text-center mt-8">
        <p className="text-gray-600">© 2025 Crazy Flips 3D. All rights reserved.</p>
      </footer>
    </div>
  );
};
